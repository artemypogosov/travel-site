...
var MobileMenu = function () {
  ...
  _createClass(MobileMenu, [{
    ...
    value: function toggleTheMenu() {
      ...
      this.siteHeader.toggleClass("site-header--transparent");
      this.menuIcon.toggleClass("site-header__menu-icon--show-x");
    }
  }]);
...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function events() {
      ...
      // pushes any key
      (0, _jquery2.default)(document).keyup(this.escapeKey.bind(this));
    }
  }, {
    key: 'escapeKey',
    value: function escapeKey(e) {
      if (e.keyCode == 27) {
        this.closeModal();
      }
    }
    ...
    value: function openModal() {
      ...
      // removes UP action when we press empty link 
      return false;
    }
  }, {
    key: 'closeModal',
